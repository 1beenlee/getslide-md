...
The inline script in [base-onefile-deck.html](../templates/base-onefile-deck.html) is the canonical implementation of this contract. Generated decks must preserve it; do not replace, simplify, remove, or rewrite it during content generation. Any navigation change belongs in the template first, followed by regenerated decks and browser QA.
